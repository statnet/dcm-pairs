# Example:  pair-formation script using init.pf wrapper and a closed population
#
# Usage: R --vanilla < pf_closed.R
#
# Rates are specified using monthly estimates
#
# Outputs are written to the output subdirectory in the file pf_closed.pdf.  
# They include the follwoing plots:
#
...
pdf("../output/pf_closed.pdf",width=8.5)
