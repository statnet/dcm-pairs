...
#
# Outputs are written to the output subdirectory in the file pf_example.pdf.  
...
pdf("../output/pf_example.pdf",width=8.5)
...
plot(mod, main="Female Population (%)",y=c("prev_s.num","prev_p.num","prev_i.num"),popfrac=FALSE,ylab="Percent",ylim=c(0,100),
...
plot(mod, main="Male Population (%)",y=c("prev_s.num","prev_p.num","prev_i.num"),popfrac=FALSE,ylab="Percent",ylim=c(0,100),
leg.name=c("susceptible","primary stage","chronic stage"),
col=c("blue","yellow","red"))
