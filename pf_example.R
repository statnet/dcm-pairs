# Example:  pair-formation script using init.pf wrapper
#
...
#
#    pf_males.pdf - male population by disease state
#    pf_males_prev.pdf - same as a percentage of male population
#    pf_females.pdf - female population by disease state
#    pf_females_prev.pdf - same as a percentage of female population
#    pf_pairs.pdf - paired population by disease state
#    pf_pairs_prev.pdf - same as a percentage of pairs in population
#    pf_overall.pdf - overall population by disease state
#    pf_overall_prev.pdf - same as population percentages
#
source("pf_model.R")
init<-init.pf(
              s.num=500000,
...
pdf("output/pf_males.pdf",width=8.5)
...
pdf("output/pf_males_prev.pdf",width=8.5)
...
pdf("output/pf_females.pdf",width=8.5)
...
pdf("output/pf_pairs_prev.pdf",width=8.5)
...
pdf("output/pf_overall.pdf",width=8.5)
...
pdf("output/pf_overall_prev.pdf",width=8.5)
