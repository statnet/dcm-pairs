...
#
# Usage: R --vanilla < pf_example.R
#
# Rates are specified using monthly estimates
#
# Outputs are written to the output subdirectory.  They include:
#
#    npf_males.pdf - male population by disease state (no pairs)
#    npf_males_prev.pdf - same as a percentage of male population ("")
#    npf_females.pdf - female population by disease state ("")
#    npf_females_prev.pdf - same as a percentage of female population ("")
#    npf_pairs.pdf - paired population by disease state ("")
#    npf_pairs_prev.pdf - same as a percentage of pairs in population ("")
#    npf_overall.pdf - overall population by disease state ("")
#    npf_overall_prev.pdf - same as population percentages ("")
#
source("pf_model.R")
init<-init.pf(
              s.num=500000,
...
pdf("output/npf_males.pdf",width=8.5)
...
pdf("output/npf_males_prev.pdf",width=8.5)
...
pdf("output/npf_females.pdf",width=8.5)
...
pdf("output/npf_females_prev.pdf",width=8.5)
plot(mod, main="Female Population (%)\n(No pairs)",y=c("prev_s.num.g2","prev_p.num.g2","prev_i.num.g2"),popfrac=FALSE,ylab="Percent",ylim=c(0,100),
leg.name=c("susceptible","primary stage","chronic stage"),
col=c("blue","yellow","red"))
dev.off()

pdf("output/npf_pairs.pdf",width=8.5)
plot(mod, main="Paired Populations\n(No pairs)",y=c("p_ss.num","p_pp.num","p_sp.num","p_si.num","p_pi.num","p_ii.num","p_pairs.num"),popfrac=FALSE,
...
pdf("output/npf_pairs_prev.pdf",width=8.5)
plot(mod, main="Paired Populations (%)\n(No pairs)",y=c("prev_p_ss.num","prev_p_pp.num","prev_p_sp.num","prev_p_si.num","prev_p_pi.num","prev_p_ii.num"),popfrac=FALSE,ylab="Percent",ylim=c(0,100),
...
pdf("output/npf_overall.pdf",width=8.5)
...
pdf("output/npf_overall_prev.pdf",width=8.5)
